...
export default async function Page({}: Props) {
   ...
   return (
      <div className="flex py-4 relative px-6 md:px-[100px]">
         ...
         <div className="bg-primary rounded py-6 px-4  lg:pl-4 lg:pr-[5rem] text-white absolute bottom-2 right-4 md:right-[3rem] md:bottom-[4rem] lg:bottom-[10rem] lg:right-[15rem]">
